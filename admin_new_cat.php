...
//-----------------------------------------------------------------------------------------------------------+
if ($_POST['add_cat'] == '1') {
$newservercat = $tp->toDB($_POST['server_cat_name']);
$reason = "";
$newok = "";
...
If ($newok == "1"){
$sql->db_Insert("aacgc_serverlist_cat", "NULL, '".$newservercat."'") or die(mysql_error());
...
$text .= "
        ...
        <input class='tbox' type='text' name='server_cat_name' size='100'>
        </td>
        </tr>";
...
<br>
	      ...
	      $ns -> tablerender("AACGC Server List (Create Category)", $text);
